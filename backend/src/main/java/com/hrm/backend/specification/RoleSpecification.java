...
public class RoleSpecification extends BaseSpecification<Role> {
    ...
    private static final Set<String> ALLOWED_SORT_FIELDS = Set.of(
            "id", "createdAt", "modifiedAt", "name", "description");

    /**
     * Tạo Specification từ SearchDto
     */
    public Specification<Role> getSpecification(SearchRoleDto dto) {
     ...
     * Tạo Sort
     */
    public Sort getSort(SearchRoleDto dto) {
     ...
     * Tạo Pageable
     */
    public Pageable getPageable(SearchRoleDto dto) {
